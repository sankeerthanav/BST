...
AVL.HIGHLIGHT_LABEL_COLOR = '#ddd';
AVL.HIGHLIGHT_LINK_COLOR = '#ddd';
AVL.HIGHLIGHT_COLOR = '#49a4e1';
AVL.HEIGHT_LABEL_COLOR = '#49a4e1';
AVL.LINK_COLOR = '#49a4e1';
AVL.HIGHLIGHT_CIRCLE_COLOR = '#49a4e1';
AVL.FOREGROUND_COLOR = '0x49a4e1';
AVL.BACKGROUND_COLOR = '#FFF';
...
function returnSubmit(funct) {
    return function (event) {
        var keyASCII = (window.event) ? event.keyCode : event.which;
...
AVL.prototype.clearHistory = function () {
    this.actionHistory = [];
};

AVL.prototype.cmd = function () {
    var i;
...
AVL.prototype.addControls = function () {
    this.insertField = addControl("Text", "");
    this.insertField.className = 'bst__input';
    this.insertField.onkeydown = returnSubmit(this.insertCallback.bind(this));
    this.insertButton = addControl("Button", "Insert");
    this.insertButton.className = 'bst__input-btn';
...
AVL.prototype.insertCallback = function () {
    ...
    if (insertedValue != '') {
        ...
        var funct = this.insertElement.bind(this);
        var val = insertedValue;
        var nxt = [funct, val];
...
AVL.prototype.disableUI = function () {
    this.insertField.disabled = true;
    this.insertButton.disabled = true;
};

AVL.prototype.enableUI = function () {
